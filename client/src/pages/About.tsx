...
export default function About() {
  return (
    <PageFrame title="Hakkımızda" description="Nechh Robotics'in yaklaşımı, ürün odağı ve çalışma ilkeleri.">
      ...
      <section className="about-roadmap"><p className="eyebrow">YÖN</p><div className="roadmap-grid"><article><span>BUGÜN</span><h3>Dikey ürünler</h3><p>Sağlık, hukuk, CBAM ve operasyon alanlarında kullanılabilir ürünler.</p></article><article><span>GELİŞİM</span><h3>AI-Fabric</h3><p>Ürün değerlendirme ve üretim disiplinini güçlendiren ortak yaklaşım.</p></article><article><span>UZUN VADE</span><h3>Robotik sistemler</h3><p>Yazılım ve yapay zekâ deneyimini gömülü sistemlere taşıma vizyonu.</p></article></div><Link href="/iletisim" className="route-link">Ekibimizle konuşun <ArrowUpRight size={18} /></Link></section>
    </PageFrame>
  );
}
